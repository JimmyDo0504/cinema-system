...
namespace rạp_chiếu_phim.khách_hàng
{
    public partial class phòng_chiếu : Form
    {
        ...
        {
            this.Close();
            UserDesign ud = new UserDesign("xx");
            ud.Show();
        }
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Vui lòng chọn ghế trước khi tiếp tục.", "Chưa chọn ghế", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            // Chuyển sang form thanh toán
            drink dr = new drink(tong);
            dr.Show();
            this.Close();
        }
    }
